/*
FortiGate WebUI Tools v0.2.4 (Fortinet Community Edition)
  ...
  fetch('https://api.github.com/repos/fwsec/fgt-webui-tools/contents')
    ...
    .then(data => {
      ...
      if (extractedVersion !== version) {
        ...
        updateItem.onclick = function () {
          handleMenuItemClick({
            script: async function (parentEl) {
              ...
              versionText.innerHTML = "<tbody><tr><td colspan=\"2\"><span style=\"font-weight:bold\">FortiGate WebUI Tools</span></td></tr><tr><td>Current Version:</td><td>" + version + "</td></tr><tr><td>New Version:</td><td>" + extractedVersion + "</td></tr></tbody>"
              ...
              link.innerText = "View latest version on GitHub"
              link.target = "_blank"
        ...
        document.getElementById("custom-menu").appendChild(updateItem);
